...
function messageHandler() {
    const sound_player = spawn('ffplay', ['-i', '-', '-hide_banner', '-nodisp']);
    const ffmpeg = spawn('ffmpeg', ['-re', '-i', options.input, '-c:a', 'copy', '-vn', '-f', 'matroska', '-', '-update', '1', '-y', '-an', tmp_out, '-hide_banner']);
